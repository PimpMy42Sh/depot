...
/*   Updated: 2016/05/13 14:18:16 by mfamilar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				cut_line(t_it *it, int offset);
void				paste_line(t_it *it, int offset);
...
t_history			*up_history(t_history *list, t_it *it, int offset);
t_history			*down_history(t_history *list, t_it *it, int offset);
