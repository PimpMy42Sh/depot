...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/09/22 11:46:25 by fjacquem          #+#    #+#             */
/*   Updated: 2016/09/22 11:46:28 by fjacquem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int											ft_abs(int i);
void										path_manager(t_env *env, int copy);
...
char										*hash_cmd(char *cmd, char
											**environ);
int											search_node_item(t_hash_tree *tree,
											char *path);
void										update_hash(t_env *e);
